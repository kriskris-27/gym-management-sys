        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left min-w-[900px]">
            <thead className="border-b border-[#1C1C1C] bg-[#0D0D0D]">
              <tr>
                <th className="text-[#333333] text-[10px] tracking-widest uppercase px-5 py-3 font-bold">
                  Member
                </th>
                <th className="text-[#333333] text-[10px] tracking-widest uppercase px-5 py-3 font-bold">
                  Check In
                ...
                filtered.map((record, idx) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() =>
                        router.push(`/admin/members/${record.memberId}`)
                      }
                    >
                      {/* Member */}
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-8 h-8 shrink-0 flex items-center justify-center rounded-full bg-[#1C1C1C] border ${isOngoing ? "border-[#D11F00]/40" : "border-[#242424]"}`}
                          >
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-[#444444] text-[11px] mt-0.5">
                              {record.memberPhone}
                            </span>
                          </div>
                        </div>
