        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="mt-8 pt-6 border-t border-[#1C1C1C] flex gap-3 items-center flex-col-reverse sm:flex-row">
            ...
            <button
              ...
              className={`themeFancyBtn w-full sm:w-auto flex-1 px-8 py-3.5 flex items-center justify-center ${success ? "themeFancyBtn--success" : createMemberMutation.isPending ? "themeFancyBtn--loading" : generalError ? "themeFancyBtn--error" : ""} ${createMemberMutation.isPending && !success ? "cursor-not-allowed" : "cursor-pointer"}`}
            >
              {success ? (
